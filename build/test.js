...
// update PCA according to the bars that user clicks.
  ...
  setup_svg = function(graph){
    ...
    var svgForPCA = divForPCA.append("svg")
    ...
    $(".divForLegend")
        .css("width", options.legend_width + "px")
        .css("height",options.legend_height + "px")
        .css("position", "absolute")
        .css("left", 800 + "px")
        .css("top", 0 + "px");

    var svgForLegend = divForLegend.append("svg")
    ...
    */
    ...
    $(".divForBar")
        .css("width", (full_width - scatterWidth - legend_width) + "px")
        .css("height", options.barChartHeight + "px")
        .css("position", "absolute")
        .css("left", (scatterWidth + legend_width) + "px")
        .css("top", 0 + "px");
